    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Connect with certified doctors, get AI-powered consultations, and manage your health journey with
              careXpert - the modern healthcare platform.
            </p>
          ...
          <div>
            <Card className="border-0 shadow-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-bold text-gray-900 dark:text-white">Try CareXpert AI</CardTitle>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Why Choose careXpert?</h2>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Experience healthcare like never before with our cutting-edge platform designed for modern patients and
            doctors.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="p-6 text-center hover:shadow-lg transition-shadow duration-300 border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
            <CardContent className="p-0">
              ...
              <p className="text-gray-600 dark:text-gray-300">Connect with certified healthcare professionals</p>
            </CardContent>
          </Card>
          ...
          <Card className="p-6 text-center hover:shadow-lg transition-shadow duration-300 border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
            <CardContent className="p-0">
              ...
              <p className="text-gray-600 dark:text-gray-300">Round-the-clock healthcare support</p>
            </CardContent>
          </Card>
          ...
          <Card className="p-6 text-center hover:shadow-lg transition-shadow duration-300 border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
            <CardContent className="p-0">
              ...
              <p className="text-gray-600 dark:text-gray-300">Your health data is protected and encrypted</p>
            </CardContent>
          </Card>
          ...
          <Card className="p-6 text-center hover:shadow-lg transition-shadow duration-300 border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
            <CardContent className="p-0">
              ...
              <p className="text-gray-600 dark:text-gray-300">Smart consultations with AI assistance</p>
            </CardContent>
          </Card>
        </div>
      </section>
