      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href={homeLink} className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">careXpert</span>
          </Link>
            ...
            {user ? (
              ...
              <>
                ...
                <Link href="/auth/patient/signup">
                  <Button className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg">Sign Up</Button>
                </Link>
              </>
            )}
          </div>
