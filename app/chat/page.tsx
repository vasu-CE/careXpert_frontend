...
export default function ChatPage() {
  ...
  const cityRooms = [
    ...
    { id: 2, name: "LA Wellness Community", members: 892, city: "Los Angeles, CA" },
  ...
  const aiMessages = [
    {
      id: 1,
      type: "ai",
      message: "Hello! I'm CareXpert AI, your health assistant. How can I help you today?",
      time: "Just now",
    },
    {
      id: 2,
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 pt-20 pb-12">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Health Chat Hub</h1>
          <p className="text-gray-600 dark:text-gray-300">
            Connect with doctors, join community discussions, or chat with our AI assistant
          </p>
        </div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-gray-900 dark:text-white text-sm">{chat.doctor}</h4>
                            <p className="text-xs text-gray-500 dark:text-gray-400">{chat.specialty}</p>
                    ...
                    {cityRooms.map((room) => (
                      ...
                      >
                        <div className="space-y-2">
                          <h4 className="font-semibold text-gray-900 dark:text-white text-sm">{room.name}</h4>
                          <div className="flex items-center gap-1">
                            <MapPin className="h-3 w-3 text-gray-400" />
                            <span className="text-xs text-gray-500 dark:text-gray-400">{room.city}</span>
                          </div>
              ...
              <CardHeader className="border-b">
                ...
                {selectedChat.startsWith("room-") && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-lg">New York Health Hub</CardTitle>
                      <CardDescription>1,247 members • New York, NY</CardDescription>
                    </div>
                  </div>
                )}
              </CardHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    {selectedChat.startsWith("doctor-") && (
                      <div className="text-center py-8">
                        <p className="text-gray-500 dark:text-gray-400">Start a conversation with your doctor</p>
                      </div>
                    )}

                    {selectedChat.startsWith("room-") && (
                      <div className="text-center py-8">
                        <p className="text-gray-500 dark:text-gray-400">Join the community discussion</p>
                      </div>
                    )}
                  </div>
                </ScrollArea>
