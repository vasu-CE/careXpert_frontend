...
export default function DoctorsPage() {
  ...
  const doctors = [
    ...
    },
    {
      ...
      avatar: "/placeholder.svg?height=80&width=80",
      verified: true,
      about: "Expert in skin conditions, cosmetic dermatology, and dermatological surgery.",
    },
    {
      id: 3,
      name: "Dr. Emily Davis",
  ...
  const locations = ["New York, NY", "Los Angeles, CA", "Chicago, IL", "Boston, MA", "Miami, FL", "Seattle, WA"]
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 pt-20 pb-12">
        ...
        {/* Results */}
        <div className="mb-6">
          <p className="text-gray-600 dark:text-gray-300">Showing {filteredDoctors.length} doctors</p>
        </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 dark:text-gray-300 mb-2">
                          ...
                          <span className="whitespace-nowrap">{doctor.experience} experience</span>
                        </div>

                        <p className="text-gray-600 dark:text-gray-300 mb-3 line-clamp-2">{doctor.about}</p>
                  ...
                  <div className="lg:col-span-4">
                    <div className="flex flex-col h-full">
                      ...
                      <div className="flex items-center justify-center gap-2 text-sm text-gray-600 dark:text-gray-300 mb-4">
                        ...
                        <span className="text-center">Next available: {doctor.nextAvailable}</span>
                      </div>
